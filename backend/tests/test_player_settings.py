...
class PlayerSettingsTests(unittest.TestCase):
    ...
    def test_player_settings_expose_fine_grained_controls(self):
        ...
        self.assertIn("Join-Path $env:LOCALAPPDATA", settings_source)
        self.assertNotIn("-OutFile '$env:LOCALAPPDATA", settings_source)
        self.assertIn("Discord presence agent was not downloaded", settings_source)
