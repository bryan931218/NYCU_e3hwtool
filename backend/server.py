...
from e3_tracker.shared.study_combined_daily_progress_runtime import install_study_combined_daily_progress_runtime
...
install_study_combined_daily_progress_runtime(web)
